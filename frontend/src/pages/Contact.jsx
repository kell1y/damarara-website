...
const CONTACT_TICKER = [
  "Get In Touch",
  "Kigali · Rwanda",
  "info@damararaltdrw.com",
  "+250 788 303 897",
  "Mon – Fri · 8am – 6pm EAT",
  "We're Here for You",
  "Questions · Orders · Feedback",
];
...
function HeaderRing() {
  ...
  return (
    <svg viewBox="0 0 200 200" className="h-full w-full" aria-hidden="true"
      style={{ animation: "rotate-ring 24s linear infinite" }}>
      <circle cx={cx} cy={cy} r={r} fill="none" stroke="#e07748"
        strokeWidth="1" strokeOpacity="0.28" strokeDasharray="4 10" />
      {[0, 120, 240].map((deg) => {
        const rad = (deg * Math.PI) / 180;
        return <circle key={deg}
          cx={cx + r * Math.sin(rad)} cy={cy - r * Math.cos(rad)}
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#0f0c11] text-white">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -top-40 -right-40 h-162 w-162 rounded-full bg-[#e07748]/9 blur-[150px]" />
        <div className="absolute top-1/2 -left-28 h-125 w-125 rounded-full bg-[#cc5832]/7 blur-[130px]" />
        <div className="absolute bottom-20 right-1/4 h-105 w-125 rounded-full bg-[#e07748]/6 blur-[120px]" />
      </div>
      ...
      <div className="relative z-10">
        ...
        <div className="relative">
          ...
          {/* Auto-rotate ring decoration — top right */}
          <div className="pointer-events-none absolute right-6 top-28 h-24 w-24 opacity-20 md:h-40 md:w-40">
            <HeaderRing />
          </div>

          {/* Header content — exits via view() scroll timeline (animation-range) */}
          <div className="section-hero-exit mx-auto max-w-3xl px-6 pt-36 pb-16 text-center md:px-10">

            {/* Eyebrow — smooth blur entrance */}
            <span
              className="mb-5 inline-flex items-center gap-3 font-serif text-sm italic font-semibold text-[#e07748]"
            ...
            {/* Divider — bar-expand */}
            <div
              className="mx-auto mt-5 mb-7 h-0.75 bg-[#cc5832]"
              style={{ animation: `bar-expand 0.9s ${EZ} 0.44s both` }}
            />

            {/* Description — fade-up */}
            <p
              className="text-[17px] leading-relaxed text-[#cfc7c9]"
              style={{ animation: `fade-up-hero 0.9s ${EZ} 0.58s both` }}
            >
        ...
        {/* ══ Contact: info | form ══════════════════════════════════════ */}
        <div className="mx-auto max-w-7xl px-6 pb-28 pt-16 md:px-12 lg:flex lg:items-start lg:gap-12">

          {/* LEFT — info column (no wrapper data-reveal; each child reveals independently) */}
          <div className="w-full lg:sticky lg:top-32 lg:w-[38%]">

            {/* Decorative product image — image reveal (img-reveal clip-path, time-based) */}
            <div className="mb-8 overflow-hidden rounded-xl">
              <img
                src={img09}
                alt="Damarara premium tea collection"
                className="h-44 w-full object-cover"
                style={{ animation: `img-reveal 1.2s ${EZ} 0.25s both` }}
              />
            </div>

            {/* "Contact Details" label — smooth blur reveal */}
            <p
              data-reveal="blur"
              className="mb-5 text-xs font-semibold uppercase tracking-[0.22em] text-[#e07748]"
            >
              Contact Details
            </p>
            ...
            {/* "Follow Us" label — smooth blur reveal */}
            <p
              data-reveal="blur"
              style={{ transitionDelay: "300ms" }}
              className="mb-4 text-[10px] font-bold uppercase tracking-[0.22em] text-[#e07748]"
            >
              Follow Us
            </p>
          ...
          {/* RIGHT — contact form, fades in from right */}
          <div
            data-reveal="right"
            ...
            <div className="overflow-hidden rounded-2xl border border-white/5 bg-[#150f12]">
              ...
              <div className="p-8 md:p-10">
                {contactDone ? (
                  ...
                  <form
                    onSubmit={(e) => { e.preventDefault(); setContactDone(true); }}
                    className="space-y-5"
                  >
                    <h3 className="mb-6 font-serif text-xl font-semibold text-[#f1ece8]">
                      Send Us a Message
                    </h3>

                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                      <label className="block">
                        <span className="mb-2 block text-[10px] font-bold uppercase tracking-[0.18em] text-[#a89b9a]">
                          Name <span className="text-[#e07748]">*</span>
                        </span>
                      ...
                      <label className="block">
                        <span className="mb-2 block text-[10px] font-bold uppercase tracking-[0.18em] text-[#a89b9a]">
                          Email <span className="text-[#e07748]">*</span>
                        </span>
                    ...
                    <label className="block">
                      <span className="mb-2 block text-[10px] font-bold uppercase tracking-[0.18em] text-[#a89b9a]">
                        Message <span className="text-[#e07748]">*</span>
                      </span>
        ...
        <div className="relative border-t border-white/5">
          ...
          <div className="pointer-events-none absolute inset-0">
            <div className="absolute top-0 left-1/2 h-87 w-175 -translate-x-1/2 rounded-full bg-[#e07748]/5 blur-[100px]" />
          </div>

          <div className="relative z-10 mx-auto max-w-2xl px-6 py-28 md:px-10">

            {/* Review section header — smooth blur reveal */}
            <div data-reveal="blur" className="mb-12 text-center">
            ...
            {/* Review form card — fade-up */}
            <div
              data-reveal="up"
              style={{ transitionDelay: "130ms" }}
              className="overflow-hidden rounded-2xl border border-white/5 bg-[#150f12]"
            >
              ...
              <div className="p-8 md:p-10">
                {reviewDone ? (
                  ...
                  <form
                    onSubmit={(e) => { e.preventDefault(); if (rating === 0) return; setReviewDone(true); }}
                    className="space-y-6"
                  >
                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                      <label className="block">
                        <span className="mb-2 block text-[10px] font-bold uppercase tracking-[0.18em] text-[#a89b9a]">
                          Your Name <span className="text-[#e07748]">*</span>
                        </span>
                      ...
                      <label className="block">
                        ...
                        <select value={review.product}
                          onChange={e => setReview(r => ({ ...r, product: e.target.value }))}
                          className={`${inputClass} appearance-none cursor-pointer`}>
                          <option value="" className="bg-[#1a1518]">Select a product</option>
                          {PRODUCTS.map(p => (
                            <option key={p} value={p} className="bg-[#1a1518]">{p}</option>
                          ))}
                        </select>
                      </label>
                    </div>
                    ...
                    <label className="block">
                      <span className="mb-2 block text-[10px] font-bold uppercase tracking-[0.18em] text-[#a89b9a]">
                        Your Review <span className="text-[#e07748]">*</span>
                      </span>
